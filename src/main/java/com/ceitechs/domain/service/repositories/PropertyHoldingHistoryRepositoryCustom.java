 ...
 * @since 1.0
 */
public interface PropertyHoldingHistoryRepositoryCustom {
 ...
 */
@Service
class PropertyHoldingHistoryRepositoryImpl implements PropertyHoldingHistoryRepositoryCustom {
    ...
    public Optional<List<PropertyHoldingHistory>> getUnitHoldingHistory(String ownerId) {
        ...
        List<String> propertyUnitIds = propertyUnitList.stream().map(PropertyUnit::getPropertyId)
